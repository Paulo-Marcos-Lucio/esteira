...
Numbers from this run — all **reproducible with `pytest` in this repository** (446 passing tests). These aren't marketing estimates; they're the ruler that catches regressions.
